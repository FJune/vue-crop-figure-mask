  ...
  <div class="vue-cropper" ref="cropper" @mouseover="scaleImg" @mouseout="cancelScale">
    ...
    >
      <span class="cropper-view-box"
        :style="{
          '-webkit-mask-box-image-source': figureMaskSrc ? 'url('+ figureMaskSrc + ')' : '',
        }"
      >
        <img
          :style="{
      ...
      <span class="cropper-face cropper-move" @mousedown="cropMove" @touchstart="cropMove" :style="imgMaskStyle"></span>
      <span
        class="crop-info"
        v-if="info"
...
export default {
  ...
  computed: {
    ...
    imgMaskStyle(){
      if (!this.figureMaskSrc) {
        return {}
      }
      return {
        '-webkit-mask-box-image-source': 'url('+ this.figureMaskSrc +')'
      }
    },
  },
  watch: {
